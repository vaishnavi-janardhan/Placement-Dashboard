...
\title[Placement Report Generation Portal]{PLACEMENT REPORT GENERATION PORTAL } % The short title appears at the bottom of every slide, the full title is only on the title page  
...
\date{June 24, 2019} % Date, can be changed to a custom date
